            ...
            <div className="h-2/3 w-2/3 bg-gray-100 flex flex-col">
                <div className="bg-gray-300 flex items-center px-4 py-2 border-b border-gray-400">
                    <div className="flex space-x-2 mr-4">
                        <button className="w-6 h-6 bg-gray-500 rounded text-white"> b </button>
                        <button className="w-6 h-6 bg-gray-500 rounded text-white"> f</button>
                    </div>
                    ...
                    <button className="ml-4 w-6 h-6 bg-gray-500 rounded text-white">r</button>
                </div>

                <div className="bg-gray-200 flex px-4 py-2 border-b border-gray-400">
                    <button className="text-gray-800 font-medium px-2 py-1 hover:bg-gray-300 rounded">Organize</button>
                    <button className="text-gray-800 font-medium px-2 py-1 hover:bg-gray-300 rounded">Open</button>
                    <button className="text-gray-800 font-medium px-2 py-1 hover:bg-gray-300 rounded">Burn</button>
                </div>
